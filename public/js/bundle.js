...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibXVoYW1tYWR0YWltb29yMTIiLCJhIjoiY2tqenBybDVtMDZyZTMxbnlzNHo4dDNteSJ9.acuvARe9pZoustYguVJ6HQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/muhammadtaimoor12/ckk2zxorm3pal18p0cdh05qkm',
    scrollZoom: false // center : [-118.6919246,34.0201613],
    // zoom : 10,
    // interactive : false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //ADD POPUP IN MAP
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://localhost:8000/api/v1/booking/checkout-session/".concat(tourId));
...
var updateUserDataAndEmail = document.querySelector('.form-user-data');
var updatePasswordAndConfirmPass = document.querySelector('.form-user-password');
...
if (updatePasswordAndConfirmPass) {
  updatePasswordAndConfirmPass.addEventListener('submit', /*#__PURE__*/function () {
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; //data-tour-id will be fetched as dataset.tourId automatically conv into tourId 
